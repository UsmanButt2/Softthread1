...
try {
  ...
  const {data} = axios.post('/api/v1/saleproduct/create-saleproduct', productData)
  if (data?.success) {
  ...
  return (
    <Layouts title={'Dashboard - CreateSaleProduct'}>
...
<div className='mb-3'>
  <button className='btn' onClick={handleCreate}>CREATE SALE PRODUCT</button>
</div>
...
export default CreateSaleProds